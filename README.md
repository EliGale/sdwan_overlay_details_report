...
+-----------+-------------+--------------+-------------+-------------+-----------+
| 10.0.0.1  | vmanage     | vmanage      | EXAMPLE-SP  | EXAMPLE-ORG | 20.15.4.1 |
| 10.0.0.2  | vmanage     | vmanage      | EXAMPLE-SP  | EXAMPLE-ORG | 20.15.4.1 |
| 10.0.0.3  | vmanage     | vmanage      | EXAMPLE-SP  | EXAMPLE-ORG | 20.15.4.1 |
+-----------+-------------+--------------+-------------+-------------+-----------+
...
+-----------+-------------+-------------+---------------+--------------------------+-----------------+---------------------------------+
| 10.0.0.1  | vmanage     | Installed   | Valid         | Jan 01 00:00:00 2026 GMT | SERIAL-NUM-0001 | eth1: 172.16.1.10/24            |
|           |             |             |               |                          |                 | eth2: 172.16.2.10/24            |
|           |             |             |               |                          |                 | system: 10.0.0.1/32             |
|           |             |             |               |                          |                 | vmanage_system: 169.254.0.1/32  |
|           |             |             |               |                          |                 | eth0: 192.168.1.10/24           |
| 10.0.0.2  | vmanage     | Installed   | Valid         | Jan 01 00:00:00 2026 GMT | SERIAL-NUM-0002 | eth1: 172.16.1.11/24            |
|           |             |             |               |                          |                 | eth2: 172.16.2.11/24            |
|           |             |             |               |                          |                 | system: 10.0.0.2/32             |
|           |             |             |               |                          |                 | vmanage_system: 169.254.0.2/32  |
|           |             |             |               |                          |                 | eth0: 192.168.1.11/24           |
| 10.0.0.3  | vmanage     | Installed   | Valid         | Jan 01 00:00:00 2026 GMT | SERIAL-NUM-0003 | eth1: 172.16.1.12/24            |
|           |             |             |               |                          |                 | eth2: 172.16.2.12/24            |
|           |             |             |               |                          |                 | system: 10.0.0.3/32             |
|           |             |             |               |                          |                 | vmanage_system: 169.254.0.3/32  |
|           |             |             |               |                          |                 | eth0: 192.168.1.12/24           |
+-----------+-------------+-------------+---------------+--------------------------+-----------------+---------------------------------+

=== Table 3 – vManage Cluster / Standalone Classification ===
+-----------+-------------+------------+-------------+------------+---------+------------------------------------------------------------------------+-------------------------+
| System-IP | Personality | Deployment | Mode        | Cluster-ID | Node-ID | Peer IPs  (idx: ip  ✓=in collection + system-ip  ✗=admin-tech missing) | Detection Notes         |
+-----------+-------------+------------+-------------+------------+---------+------------------------------------------------------------------------+-------------------------+
| 10.0.0.1  | vmanage     | Cluster    | MultiTenant | cluster-01 | 0       | [0] 172.16.2.10 (self)                                                 | memberMap has 3 entries |
|           |             |            |             |            |         | [1] 172.16.2.11 ✓ 10.0.0.2                                             |                         |
|           |             |            |             |            |         | [2] 172.16.2.12 ✓ 10.0.0.3                                             |                         |
+-----------+-------------+------------+-------------+------------+---------+------------------------------------------------------------------------+-------------------------+
| 10.0.0.2  | vmanage     | Cluster    | MultiTenant | cluster-01 | 1       | [0] 172.16.2.10 ✓ 10.0.0.1                                             | memberMap has 3 entries |
|           |             |            |             |            |         | [1] 172.16.2.11 (self)                                                 |                         |
|           |             |            |             |            |         | [2] 172.16.2.12 ✓ 10.0.0.3                                             |                         |
+-----------+-------------+------------+-------------+------------+---------+------------------------------------------------------------------------+-------------------------+
| 10.0.0.3  | vmanage     | Cluster    | MultiTenant | cluster-01 | 2       | [0] 172.16.2.10 ✓ 10.0.0.1                                             | memberMap has 3 entries |
|           |             |            |             |            |         | [1] 172.16.2.11 ✓ 10.0.0.2                                             |                         |
|           |             |            |             |            |         | [2] 172.16.2.12 (self)                                                 |                         |
+-----------+-------------+------------+-------------+------------+---------+------------------------------------------------------------------------+-------------------------+

=== Table 3.5 – Multi-Tenant Cluster Services ===
    Source: 10.0.0.1-vmanage-admin-tech-example.tar  |  System-IP: 10.0.0.1  |  Mode: MultiTenant

+--------------+------------+-------------+---------------+------------------+--------------+-------------+---------+---------+----------+----------+
| IP Address   | app-server | config-db   | container-mgr | coord-server     | data-collect | messaging   | olap-db | sdavc   | sdavc-gw | stats-db |
+--------------+------------+-------------+---------------+------------------+--------------+-------------+---------+---------+----------+----------+
| 172.16.2.10  | ✓ 8443     | ---         | ✓ 10504       | ---              | ---          | ---         | ---     | ---     | ---      | ---      |
| 172.16.2.11  | ✓ 8443     | ---         | ✓ 10504       | ---              | ---          | ---         | ---     | ---     | ---      | ---      |
| 172.16.2.12  | ✓ 8443     | ---         | ✓ 10504       | ---              | ---          | ---         | ---     | ---     | ---      | ---      |
| 169.254.1.X  | ---        | ---         | ---           | ✓ 2181,2888:3888 | ---          | ---         | ---     | ---     | ---      | ---      |
| 169.254.1.Y  | ---        | ✓ 5000,7687 | ---           | ---              | ---          | ---         | ---     | ---     | ---      | ---      |
| 169.254.1.Z  | ---        | ---         | ---           | ---              | ---          | ✓ 4222,6222 | ---     | ---     | ---      | ---      |
| 169.254.1.W  | ---        | ---         | ---           | ---              | ---          | ---         | ---     | ---     | ---      | ✓ 9300   |
+--------------+------------+-------------+---------------+------------------+--------------+-------------+---------+---------+----------+----------+

=== Disaster Recovery configuration NOT found ==

  File: 10.0.0.1-vmanage-admin-tech.tar/opt/web-app/etc/deployment
...
=== Disaster Recovery configuration NOT found ==
  ...
  File: 10.0.0.2-vmanage-admin-tech.tar/opt/web-app/etc/deployment
...
=== Disaster Recovery configuration NOT found ==
  ...
  File: 10.0.0.3-vmanage-admin-tech.tar/opt/web-app/etc/deployment
...
+-----------+-------------+---------------+---------------+------------+-----------------+---------+-------------+---------------+---------------+
| System-IP | Personality | eth1          | eth2          | system     | vmanage_system  | docker0 | cbr-vmanage | eth0          | cbr-vmanage-1 |
+-----------+-------------+---------------+---------------+------------+-----------------+---------+-------------+---------------+---------------+
| 10.0.0.1  | vmanage     | 172.16.1.10/24| 172.16.2.10/24| 10.0.0.1/32| 169.254.0.1/32  | N/A     | N/A         | 192.168.1.10/24| N/A           |
| 10.0.0.2  | vmanage     | 172.16.1.11/24| 172.16.2.11/24| 10.0.0.2/32| 169.254.0.2/32  | N/A     | N/A         | 192.168.1.11/24| N/A           |
| 10.0.0.3  | vmanage     | 172.16.1.12/24| 172.16.2.12/24| 10.0.0.3/32| 169.254.0.3/32  | N/A     | N/A         | 192.168.1.12/24| N/A           |
+-----------+-------------+---------------+---------------+------------+-----------------+---------+-------------+---------------+---------------+  
```
